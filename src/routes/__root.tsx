...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://arnavphysiotherapy.com" },
      { property: "og:image", content: "https://arnavphysiotherapy.com/og-image.svg" },
      ...
      { name: "twitter:image", content: "https://arnavphysiotherapy.com/og-image.svg" },
    ...
    links: [
      ...
      { rel: "canonical", href: "https://arnavphysiotherapy.com" },
    ],
  }),
